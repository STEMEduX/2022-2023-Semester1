...
def main():
    ...
    # # curly brackts define directionary
    ...
    # directions are tuples: Rooms to (N,E,S,W)
    ...
    #rooms where Johnny's basket might be---List
    ...
    while True:
        if eggs_delivered and room['name'] == 'Entrance Way':
            print('You\'ve delivered the eggs and returned to the entrance.' + 'You can now leave. Congrats!')
            break;
        ...
        while stuck:
            ...
            if choice == -1:
                ...
                dir = print("You can not go in that direction.")
            else:
